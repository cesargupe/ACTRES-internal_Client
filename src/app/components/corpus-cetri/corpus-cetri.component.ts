...
@Component({
  selector: 'app-corpus-cetri',
  templateUrl: './corpus-cetri.component.html',
  styleUrls: ['./corpus-cetri.component.css']
})
export class CorpusCetriComponent implements OnInit {
  ...
  saveContent(){
    ...
    let action = {'title': 'edit', 'datasheet': {'oldName': this.content.data.corpus[this.newContent.index].name, 'newName': this.newContent.name, 'type': 'corpus-cetri'}};
  ...
  deleteContent(index){
    ...
    let action = {'title': 'delete', 'datasheet': {'oldName': this.content.data.corpus[index].name, 'type': 'corpus-cetri'}};
